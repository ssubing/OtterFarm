...
class Enemy1 extends Component {
    ...
    render() {
        return <EnemyBase ref="base" update={this.update.bind(this)} position={this.state.position} dimensions={this.state.dimensions} moveEnemy={this.move.bind(this)} className="enemy1"></EnemyBase>;
    }
}
